...
using XunitWebAPPMVCVSix.Repository;
using XunitWebAPPMVCVSix.Validation;


namespace XunitWebAPPMVCVSix.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public EmployeesController(IEmployeeRepository repo,AccountNumberValidation validation,EmployeeContext context)
        {
            _repo = repo;
...
/*            if(!_validation.IsValid(employee.AccountNumber))
            {
                ModelState.AddModelError("AcocuntNumber", "A/c is Not Correct");
            }
