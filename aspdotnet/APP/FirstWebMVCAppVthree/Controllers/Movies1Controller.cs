...
namespace FirstWebMVCAppVthree.Controllers
{
    public class Movies1Controller : Controller
    {
        private readonly FirstWebMVCAppVthreeContext _context;

        public Movies1Controller(FirstWebMVCAppVthreeContext context)
        {
            _context = context;
        }
